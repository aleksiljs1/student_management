...
const Dashboard = () => {
  ...
  const renderStatCard = (title: string, value: number | undefined, icon: React.ReactNode, color: string) => (
  ...
  return (
    <div className="bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8">
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-800">University Statistics Dashboard</h1>
          <p className="text-gray-600 mt-2">Get insights into faculty, class, and student performance</p>
        </div>
        ...
        {!loading && activeTab === "overview" && (
          <>
            ...
            <div className=" shadow-md p-6 mb-8 ">
              <h3 className="text-lg font-semibold text-gray-800 mb-4">Student GPA Distribution</h3>
              <GpaScatterPlot />
            </div>
          </>
        )}
        ...
        {!loading && activeTab === "students" && (
          <div className="space-y-6">
            <div className="bg-white  shadow-md p-7">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                <div className="h-80"> {/* Fixes height issue, need another solution for later doe */}
                  <GpaDistributionChart />
                </div>
                <div className="bg-gray-50 p-6 ">
                  ...
                  <ul className="space-y-2  text-gray-600">
                    <li className="flex items-center">
                      ...
                      <span>High performers (GPA &gt; 3.0) represent a significant portion of students</span>
                    </li>
                    <li className="flex items-center">
                      <span className="w-3 h-3 bg-indigo-500 rounded-full mr-2"></span>
                      <span>Average performers (GPA 2.0-3.0) make up the majority</span>
                    </li>
                    <li className="flex items-center">
                      <span className="w-3 h-3 bg-red-500 rounded-full mr-2"></span>
                      <span>Low performers (GPA &lt; 2.0) may need additional support</span>
                    </li>
                  </ul>
                </div>
              </div>
