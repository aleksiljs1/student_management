/*
  ...
  - You are about to drop the column `facultyId` on the `Class` table. All the side-data in the column will be lost.
  - The primary key for the `Student` table will be changed. If it partially fails, the table could be left without primary key constraint.
  - You are about to drop the column `classId` on the `Student` table. All the side-data in the column will be lost.
  - You are about to drop the column `facultyId` on the `Student` table. All the side-data in the column will be lost.
  - You are about to drop the column `id` on the `Student` table. All the side-data in the column will be lost.
  - You are about to drop the column `studentId` on the `Student` table. All the side-data in the column will be lost.
